...
| 2 | Sub-características desactualizadas — riesgo ya materializado: `PACS-Fase2-Herramientas.md` v1.0 declaraba *Tolerancia a fallos + Capacidad de recuperación* como sub-características, abandonadas tras la realineación del equipo a *Madurez + Tolerancia a Fallos* (`referencias/objetivos.txt`) | Absorción y regeneración del anexo a v2.0 (issue #5, PR de seguimiento a este) |
